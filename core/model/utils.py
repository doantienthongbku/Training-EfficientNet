...
def round_filters(filters, global_params):
    ...
    Args:
        filters (int): Filter number to be calculated
        global_params (namedtuple): Global params of the model
    """
    width_multiplier = global_params.width_coefficient
...
def efficientnet(width_coefficient=None, depth_coefficient=None, image_size=None,
    ...
    Args:
        with_coefficient (float, optional). Defaults to None.
        depth_coefficient (float, optional). Defaults to None.
